...
from .views_recepcion import recepcion_view, editar_atencion_view, reportes_view, actualizar_pago_rapido, validar_atencion_rapida, buscar_pacientes_ajax, update_detalle_tratamiento
