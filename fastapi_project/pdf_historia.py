...
def generar_historia_clinica_pdf(paciente, sucursal=None):
    ...
    if logo_path:
        try:
            # Logo ubicado justo a partir de la parte inferior de la posicion anterior (y=page_height-70)
            c_header.drawImage(logo_path, -20, page_height - 70, width=160, height=50, preserveAspectRatio=True, mask='auto')
        except Exception:
            pass
